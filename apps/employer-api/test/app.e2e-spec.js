...
/*!************************************************!*\
  !*** ./apps/employer-api/test/app.e2e-spec.ts ***!
  \************************************************/
...
const _employerapimodule = __webpack_require__(/*! ./../src/employer-api.module */ "./apps/employer-api/src/employer-api.module.ts");
...
describe('EmployerApiController (e2e)', ()=>{
    ...
    beforeEach(async ()=>{
        const moduleFixture = await _testing.Test.createTestingModule({
            imports: [
                _employerapimodule.EmployerApiModule
            ]
        }).compile();
